...
const createTableStatements = [
  ...
  `CREATE TABLE character_run_states (
    ...
    last_checkpoint_x REAL NOT NULL DEFAULT -5,
    last_checkpoint_y REAL NOT NULL DEFAULT 0,
    last_checkpoint_z REAL NOT NULL DEFAULT 4,
...
async function seedData() {
  ...
  const [demoCharacter] = await db
    ...
    .values({
      userId: demoUser.id,
      characterName: "Tharaz",
      origin: "Mordor Conscript",
      className: "Rogue",
      affinity: "Shadow",
      level: 1,
      xp: 0,
...
try {
  ...
  console.log("Sauron's Conquest database seeded successfully.");
  ...
  console.error("Failed to seed Sauron's Conquest database.");
  console.error(error);
  process.exit(1);
}
